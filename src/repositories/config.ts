...
const API_PROTOCOL: string  = 'http' // process.env.PUBLIC_API_PROTOCOL // 'http'
const API_HOSTNAME: string = 'localhost' // process.env.PUBLIC_API_HOSTNAME //'localhost'
const API_PORT: number = 8089 // +process.env.PUBLIC_API_PORT // '8089'
