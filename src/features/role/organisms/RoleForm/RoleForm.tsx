...
import roleFormStyles from './roleForm.module.css';
        ...
        <form ref={form} class={formStyles.form_flex}>
            ...
            <div class={formStyles.field_wrapper}>
                <FormControl isRequired isInvalid={!!errors('slug')}>
                    <FormControlLabel class={formStyles.form_label} for="slug" _dark={{ _after: { color: 'danger.300' } }}>
                        {t('slug')}
                    </FormControlLabel>
                    <Input
                        _dark={darkInput}
            ...
            <div class={formStyles.field_wrapper}>
                <FormControl id="permissions" isRequired isInvalid={!!errors('permissions')}>
                    <FormControlLabel class={formStyles.form_label} for="permissions" _dark={{ _after: { color: 'danger.300' } }}>
                        {t('permissions')}
                    </FormControlLabel>
                    <MultiSelect
                        name={'permissions'}
            ...
            <div class={formStyles.field_wrapper}>
                <FormControl isRequired isInvalid={!!errors('enable')}>
                    <FormControlLabel class={formStyles.form_label} _dark={{ _after: { color: 'danger.300' } }}>
                        {t('enable')}
                    </FormControlLabel>
                    <Switch
                        name={'enable'}
            ...
            <div class={formStyles.update_save_buttons_container} data-parent={props.requiredPermission.submit}>
